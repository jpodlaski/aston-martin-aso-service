...
/**
 * Issues and consumes one-time client account tokens (reset / verify / delete).
...
public class AccountTokenService {
    ...
    public String issue(Customer customer, AccountTokenPurpose purpose) {
        ...
        long ttl = switch (purpose) {
            case PASSWORD_RESET, ACCOUNT_DELETION -> passwordResetTtlSeconds;
            case EMAIL_VERIFICATION -> emailVerificationTtlSeconds;
        };
    ...
    public void deleteAllForCustomer(Long customerId) {
        tokenRepository.deleteAllForCustomer(customerId);
    }
